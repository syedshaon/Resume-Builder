      ...
      <div className="px-2   text-sm leading-normal text-blue-gray-500/80  ">
        {references.map((item) => (
          <div key={item.id} className="relative mb-1">
            <h6 className="mb-0">
              <button onClick={() => handleCheckboxChange(item.id)} className="relative flex items-center w-full p-4 py-2 font-semibold text-left transition-all ease-in border-b border-solid cursor-pointer border-slate-300 text-slate-700 rounded-t-1 group text-dark-500">
