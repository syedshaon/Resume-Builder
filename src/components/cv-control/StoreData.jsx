...
import { collection, addDoc, doc, where, updateDoc, getDoc, QuerySnapshot, query, onSnapshot, deleteDoc, getDocs } from "firebase/firestore";
    ...
    const fetchData = async () => {
      ...
      if (userData.data) {
        ...
        if (userConfirms) {
          ...
          setHColor(userData.data.hColor);
